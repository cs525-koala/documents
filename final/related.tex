...
framework for Dryad and MapReduce-like systems.  They reduced their scheduling algorithm to
...
workloads.  In our project, we built a similar parameterized scheduler,
but instead target Eucalyptus, which has fundamentally different scheduling
